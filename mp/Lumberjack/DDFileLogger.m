...
#define NSLogError(frmt, ...)    do{ if(LOG_LEVEL >= 1) DDLogVerbose((frmt), ##__VA_ARGS__); } while(0)
#define NSLogWarn(frmt, ...)     do{ if(LOG_LEVEL >= 2) DDLogVerbose((frmt), ##__VA_ARGS__); } while(0)
#define NSLogInfo(frmt, ...)     do{ if(LOG_LEVEL >= 3) DDLogVerbose((frmt), ##__VA_ARGS__); } while(0)
#define NSLogVerbose(frmt, ...)  do{ if(LOG_LEVEL >= 4) DDLogVerbose((frmt), ##__VA_ARGS__); } while(0)
